    ...
    <li className="record-card paper-job-card">
      <div>
        ...
        <dl className="compact-definitions compact-definitions--jobs">
          ...
          <div><dt>{t("latestAttempt")}</dt><dd>{job.latest_attempt ? t("attemptSummary", { number: job.latest_attempt.attempt_number, status: job.latest_attempt.status }) : common("notAvailable")}</dd></div>
