...
STABLE_API_ERRORS: tuple[StableApiError, ...] = (
    ...
    StableApiError("paper_execution_upstream_authority_not_found", "not_found"),
    StableApiError("paper_execution_order_not_found", "not_found"),
    StableApiError("paper_execution_attempt_not_found", "not_found"),
    StableApiError("paper_execution_fill_not_found", "not_found"),
    StableApiError("paper_execution_idempotency_conflict", "conflict"),
    StableApiError("paper_execution_stale_authority", "conflict"),
    StableApiError("paper_execution_operation_conflict", "conflict"),
    StableApiError("paper_execution_concurrency_conflict", "conflict"),
    StableApiError("paper_execution_reconciliation_required", "conflict"),
    StableApiError("paper_execution_invalid_policy", "invalid"),
    StableApiError("paper_execution_invalid_decimal", "invalid"),
    StableApiError("paper_execution_invalid_cursor", "invalid"),
    StableApiError("paper_execution_authority_unavailable", "unavailable"),
    StableApiError("paper_execution_schema_incompatible", "unavailable"),
    StableApiError("paper_execution_storage_busy", "unavailable"),
    StableApiError("paper_execution_storage_failure", "unavailable"),
    StableApiError("paper_runtime_not_found", "not_found"),
    StableApiError("paper_runtime_idempotency_conflict", "conflict"),
    StableApiError("paper_runtime_already_exists", "conflict"),
    StableApiError("paper_runtime_binding_conflict", "conflict"),
    StableApiError("paper_runtime_lifecycle_conflict", "conflict"),
    StableApiError("paper_runtime_version_conflict", "conflict"),
    StableApiError("paper_runtime_ownership_conflict", "conflict"),
    StableApiError("paper_runtime_continuation_stale", "conflict"),
    StableApiError("paper_runtime_invalid_cursor", "invalid"),
    StableApiError("paper_runtime_invalid_input", "invalid"),
    StableApiError("paper_runtime_authority_unavailable", "unavailable"),
    StableApiError("paper_runtime_schema_incompatible", "unavailable"),
    StableApiError("paper_runtime_storage_busy", "unavailable"),
    StableApiError("paper_runtime_storage_failure", "unavailable"),
    StableApiError("paper_runtime_authority_corrupt", "unavailable"),
