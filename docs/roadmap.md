...
Sprint 93 should persist a paper run artifact to an explicit local path using the existing Milestone 17 writer before any default output-root workflow, CLI behavior, configured-run integration, broker readiness, or live execution is added.
